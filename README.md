...
This is our backend lambda functions which can be used to interface with for anti-resume! To get started with contributing, you need to install the AWS CLI, and might need to get some credentials. Check out the [installation guide](https://docs.aws.amazon.com/serverless-application-model/latest/developerguide/serverless-getting-started.html)! The SAM template guide is super helpful as well, telling you everything you need to run the app.

Will be updated and I'll add more stuff here!

# SAM Deploy Artifacts, Super Helpful Though!
...
```bash
aws cloudformation delete-stack --stack-name anti-resume-backend
```
